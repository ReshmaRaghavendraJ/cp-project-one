...
export default function Studreg() 
{
    ...
    useEffect(()=>{
        ...
        Getallcoursedetails();     //Dropdown list for Course list
        Getallbranchdetails();       //Dropdownlist for Branch list
      },[])
    ...
    function Getallbranchdetails()         /* Drop down list for all Branch Details */
    {
      axios
